...
const PROJECTS = [
  {
    banner:"🕹️", bannerBg:"linear-gradient(135deg,#0f1020,#1a1535)",
    hackathon:true, title:"3D Hackathon Game",
    desc:"Built a fully playable 3D game in a hackathon sprint alongside a 3-person team. Designed mechanics, collaborated on architecture under time pressure, and shipped a working product — because games are the most underrated form of creative engineering.",
    tags:[["Unity","tp"],["C#","tg"],["3D Game Dev","tv"],["Team Collab","tc"],["Hackathon","ty"]],
    links:[{ label:"⭐ GitHub", cls:"pl-gh", href:"https://github.com/SuShoonLei" }],
  },
  {
    banner:"🤖", bannerBg:"linear-gradient(135deg,#0f1e1e,#152020)",
    title:"AI-Powered Web App",
    desc:"A web application integrating an AI/ML backend with a clean React frontend. Built to explore the intersection of intelligent systems and delightful, thoughtful UX.",
    tags:[["React","tv"],["Python","tc"],["AI/ML","tg"]],
    links:[{ label:"⭐ GitHub", cls:"pl-gh", href:"https://github.com/SuShoonLei" },{ label:"🚀 Demo", cls:"pl-live", href:"https://github.com/SuShoonLei" }],
  },
  {
    banner:"🌐", bannerBg:"linear-gradient(135deg,#14141e,#1a1a28)",
    title:"Full-Stack Web Project",
    desc:"A full-stack application with Node.js backend and React frontend featuring user authentication, MySQL database, and a responsive UI that's both beautiful and functional.",
    tags:[["Node.js","tg"],["React","tv"],["MySQL","tc"]],
    links:[{ label:"⭐ GitHub", cls:"pl-gh", href:"https://github.com/SuShoonLei" },{ label:"🚀 Demo", cls:"pl-live", href:"https://github.com/SuShoonLei" }],
  },
  {
    banner:"🔐", bannerBg:"linear-gradient(135deg,#1a1510,#221e14)",
    title:"Cybersecurity / Systems Project",
    desc:"Hands-on exploration of cybersecurity fundamentals — secure systems, vulnerability analysis, or network tooling built in C or Python with a focus on low-level thinking.",
    tags:[["C","ti"],["Python","tc"],["Security","tp"]],
    links:[{ label:"⭐ GitHub", cls:"pl-gh", href:"https://github.com/SuShoonLei" }],
  },
];
