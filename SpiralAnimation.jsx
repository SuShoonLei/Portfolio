...
class AnimationController {
  constructor(canvas, ctx, dpr, size, numberOfStars) {
    this.time = 0;
    this.canvas = canvas;
    this.ctx = ctx;
    this.dpr = dpr;
...
/**
 * Spiral canvas (GSAP). For full viewport omit width/height; for link hovers pass small dimensions + lower starCount.
 */
export function SpiralAnimation({
  ...
  const fullBleed = width == null && height == null;
  ...
  useEffect(() => {
    ...
    const w = fullBleed ? dimensions.width : width;
    const h = fullBleed ? dimensions.height : height;
  ...
  }, [dimensions.width, dimensions.height, width, height, starCount, fullBleed]);
